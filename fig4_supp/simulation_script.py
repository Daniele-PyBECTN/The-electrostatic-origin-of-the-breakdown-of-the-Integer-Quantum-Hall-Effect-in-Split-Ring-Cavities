...
W = 100  # spatial width of the system ( Nx )
L = 50  # spatial length of the system ( Ny )

NET = 11    #number of states to compute T
...
E_dis = omB0 * .01                   # disorder amplitude in cyclotrons
